...
// http://msdn.microsoft.com/en-us/library/vstudio/hh567368(v=vs.120).aspx
    ...
    // N1720
		...
		#define GLM_HAS_STATIC_ASSERT         \
			((GLM_LANG & GLM_LANG_CXX0X_FLAG) \
			 && (((GLM_COMPILER & GLM_COMPILER_CUDA)) || ((GLM_COMPILER & GLM_COMPILER_VC)) || ((GLM_COMPILER & GLM_COMPILER_HIP))))
	#endif
    ...
    // N1988
		...
		#define GLM_HAS_EXTENDED_INTEGER_TYPE                                            \
			(((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (GLM_COMPILER & GLM_COMPILER_VC))      \
			 ...
			 || ((GLM_LANG & GLM_LANG_CXX0X_FLAG) && (GLM_COMPILER & GLM_COMPILER_CLANG)) || ((GLM_COMPILER & GLM_COMPILER_HIP)))
	#endif
		...
		#define GLM_HAS_INITIALIZER_LISTS                                                                                                   \
			((GLM_LANG & GLM_LANG_CXX0X_FLAG)                                                                                               \
			 && (((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC15))                                                  \
			     || ((GLM_COMPILER & GLM_COMPILER_INTEL) && (GLM_COMPILER >= GLM_COMPILER_INTEL14)) || ((GLM_COMPILER & GLM_COMPILER_CUDA)) \
    ...
    // N2544 Unrestricted unions http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2008/n2544.pdf
		...
		#define GLM_HAS_UNRESTRICTED_UNIONS  \
			(GLM_LANG & GLM_LANG_CXX0X_FLAG) \
			    && ((GLM_COMPILER & GLM_COMPILER_VC) || ((GLM_COMPILER & GLM_COMPILER_CUDA)) || ((GLM_COMPILER & GLM_COMPILER_HIP)))
	#endif
    ...
    // N2346
		...
		#define GLM_HAS_DEFAULTED_FUNCTIONS                                                                                             \
			((GLM_LANG & GLM_LANG_CXX0X_FLAG)                                                                                           \
			     && (((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC12)) || ((GLM_COMPILER & GLM_COMPILER_INTEL)) \
		...
		#define GLM_HAS_EXPLICIT_CONVERSION_OPERATORS                                                                                 \
			((GLM_LANG & GLM_LANG_CXX0X_FLAG)                                                                                         \
			 && (((GLM_COMPILER & GLM_COMPILER_INTEL) && (GLM_COMPILER >= GLM_COMPILER_INTEL14))                                      \
			     || ((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC12)) || ((GLM_COMPILER & GLM_COMPILER_CUDA)) \
			     || ((GLM_COMPILER & GLM_COMPILER_HIP))))
	#endif
    ...
    // N2258 http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2007/n2258.pdf
		...
		#define GLM_HAS_TEMPLATE_ALIASES                                                                                            \
			((GLM_LANG & GLM_LANG_CXX0X_FLAG)                                                                                       \
			 && (((GLM_COMPILER & GLM_COMPILER_INTEL)) || ((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC12)) \
    ...
    // N2930 http://www.open-std.org/jtc1/sc22/wg21/docs/papers/2009/n2930.html
		...
		#define GLM_HAS_RANGE_FOR                                                                                                    \
			((GLM_LANG & GLM_LANG_CXX0X_FLAG)                                                                                        \
			 && (((GLM_COMPILER & GLM_COMPILER_INTEL)) || ((GLM_COMPILER & GLM_COMPILER_VC)) || ((GLM_COMPILER & GLM_COMPILER_CUDA)) \
			     || ((GLM_COMPILER & GLM_COMPILER_HIP))))
	#endif
		...
		#define GLM_HAS_ALIGNOF                                                                                                       \
			((GLM_LANG & GLM_LANG_CXX0X_FLAG)                                                                                         \
			 && (((GLM_COMPILER & GLM_COMPILER_INTEL) && (GLM_COMPILER >= GLM_COMPILER_INTEL15))                                      \
			     || ((GLM_COMPILER & GLM_COMPILER_VC) && (GLM_COMPILER >= GLM_COMPILER_VC14)) || ((GLM_COMPILER & GLM_COMPILER_CUDA)) \
			     || ((GLM_COMPILER & GLM_COMPILER_HIP))))
	#endif
